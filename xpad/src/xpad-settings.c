...
save_to_file (XpadSettings *settings, const gchar *filename)
{
	...
	fio_set_values_to_file (filename, 
		...
		"b|edit_lock", settings->priv->edit_lock,
		"b|sticky_on_start", settings->priv->sticky,
		"i|back_red", settings->priv->back ? settings->priv->back->red : 0,
		"i|back_green", settings->priv->back ? settings->priv->back->green : 0,
		"i|back_blue", settings->priv->back ? settings->priv->back->blue : 0,
		"b|use_back", settings->priv->back ? TRUE : FALSE,
		"i|text_red", settings->priv->text ? settings->priv->text->red : 0,
		"i|text_green", settings->priv->text ? settings->priv->text->green : 0,
		"i|text_blue", settings->priv->text ? settings->priv->text->blue : 0,
